package com.wanda.kyc.utils.googleauth;
...
public class GoogleAuthenticatorUtils {
	 ...
	 * 之间生成的TOTP 能校验通过 如果为1,则表明在 10:09:30-10:10:00 10:10:00-10:10:30 10:10:30-10:11:00 之间生成的TOTP
	 * 能校验通过 以此类推
	 */
	...
	public static String createGoogleAuthQRCodeData(String secret, String account, String issuer) {
		...
		try {
			return String.format(qrCodeData, URLEncoder.encode(issuer + ":" + account, "UTF-8").replace("+", "%20"),
...
//		 System.out.println(createSecretKey());
		String secretKey = "4n7ntlnqqh34fjwcoixgfg5ydlr7hyjg";
		String account = "admin";
		String envPlatform = "dev-running-point";

		 System.out.println(createGoogleAuthQRCodeData(secretKey, account, envPlatform));

		String code = "328960";
//		System.out.println(verify(secretKey, code));
	}
